  ...
  let data = [
    {
      title: "Swift",
      id: 1,
      main: "/icons/swift.png",
      desc: "Swift is a powerful and intuitive programming language for iOS, macOS, watchOS, and tvOS.",
      tag: "Programming",
      bg: "bg-yellow-50",
    ...
    },
    {
      title: "SwiftUI",
      id: 2,
      main: "/icons/swiftui.png",
      desc: "A modern UI framework by Apple for declarative and dynamic UI development on all Apple platforms.",
      tag: "Framework",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      title: "UIKit",
      id: 3,
      main: "/icons/uikit.jpeg",
      desc: "A powerful framework for building iOS user interfaces with extensive customization.",
      tag: "Framework",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      title: "Flutter",
      id: 4,
      main: "/icons/flutter.svg",
      desc: "An open-source UI framework by Google for building natively compiled apps for mobile, web, and desktop from a single codebase.",
      tag: "Framework",
      bg: "bg-cyan-50",
      text: "text-cyan-500",
    },
    {
      ...
      id: 5,
      main: "/icons/dart.svg",
      desc: "A programming language optimized for UI development, primarily used with Flutter.",
      tag: "Programming",
      bg: "bg-yellow-50",
      text: "text-yellow-500",
    },
    {
      title: "Objective-C",
      id: 6,
      main: "/icons/obj-c.png",
      desc: "Objective-C is a powerful and intuitive programming language for iOS, macOS, watchOS, and tvOS.",
      tag: "Programming",
      bg: "bg-yellow-50",
      text: "text-yellow-500",
    },
    {
      ...
      desc: "A backend platform by Google providing services like authentication, Firestore, push notifications, and more.",
      tag: "Backend",
      bg: "bg-orange-50",
    ...
    },
    {
      ...
      desc: "A developer's go-to platform for version control and collaborative development.",
      tag: "Version Control",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      ...
      desc: "Designing scalable and maintainable mobile applications with MVVM, VIPER, and clean architecture principles.",
      tag: "Specialties",
      bg: "bg-orange-500",
